...
//wrapper class  functional interfaces has no throws exception -LongConsumer zorunlu old icin ILongConsumer yapamayiz
//tek cözüm wrapper class
class GeneratePrimes {
    ...
    private void generateForTextForEachCallback(BufferedWriter bw, long val)
    {
        ...
        //this the place where we handled
        catch (IOException ex) {
            ex.printStackTrace();
        }
    }
